  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        success: { DEFAULT:"hsl(var(--success))",50:"var(--success-50)",100:"var(--success-100)",500:"var(--success-500)" },
        warning: { DEFAULT:"hsl(var(--warning))",50:"var(--warning-50)",100:"var(--warning-100)",500:"var(--warning-500)" },
        chart: {
          "1": "hsl(var(--chart-1))",
          "2": "hsl(var(--chart-2))",
          "3": "hsl(var(--chart-3))",
      ...
      animation: {
        ...
        "fade-in":"fade-in 400ms cubic-bezier(0,0,0.2,1)",
      },
    },
  },
